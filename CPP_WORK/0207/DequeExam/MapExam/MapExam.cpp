// MapExam.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
int main()
{
    ...
    pitcherList.insert(std::make_pair("Chango", 2.12));
    ...
    std::cout << "Chaho's ERA : " << pitcherList["Chango"] << endl;
    //pitcherList["ChooChoo"] = 8.51;
    std::cout << "ChooChoo's ERA : " << pitcherList["ChooChoo"] <<  endl;
